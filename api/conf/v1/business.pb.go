...
func (x *Business_Jwt) GetRefreshAfter() string {
	if x != nil {
...
func (x *Business_Jwt) GetAccessExpire() string {
	if x != nil {
...
var file_conf_v1_business_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x0c, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x41, 0x66, 0x74, 0x65,
