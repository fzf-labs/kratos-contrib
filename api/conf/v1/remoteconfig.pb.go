...
// 	protoc        (unknown)
// source: api/conf/v1/remoteconfig.proto
...
const file_api_conf_v1_remoteconfig_proto_rawDesc = "" +
	"\n" +
	"\x1eapi/conf/v1/remoteconfig.proto\x12\x04conf\x1a\x1egoogle/protobuf/duration.proto\"\xe1\x05\n" +
	"\fRemoteConfig\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12+\n" +
	"\x04etcd\x18\x02 \x01(\v2\x17.conf.RemoteConfig.EtcdR\x04etcd\x121\n" +
	"\x06consul\x18\x03 \x01(\v2\x19.conf.RemoteConfig.ConsulR\x06consul\x12.\n" +
	"\x05nacos\x18\x04 \x01(\v2\x18.conf.RemoteConfig.NacosR\x05nacos\x121\n" +
	"\x06apollo\x18\x06 \x01(\v2\x19.conf.RemoteConfig.ApolloR\x06apollo\x12=\n" +
	"\n" +
	"kubernetes\x18\a \x01(\v2\x1d.conf.RemoteConfig.KubernetesR\n" +
	"kubernetes\x1aG\n" +
	"\x05Nacos\x12\x18\n" +
	...
	"\x03key\x18\x03 \x01(\tR\x03key\x1a\x8a\x01\n" +
	"\x06Apollo\x12\x1a\n" +
	...
	"\n" +
	"Kubernetes\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespaceB\x89\x01\n" +
	"\bcom.confB\x11RemoteconfigProtoP\x01Z:github.com/fzf-labs/kratos-contrib/api/conf/v1/api/conf/v1\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"

var (
	file_api_conf_v1_remoteconfig_proto_rawDescOnce sync.Once
	file_api_conf_v1_remoteconfig_proto_rawDescData []byte
)

func file_api_conf_v1_remoteconfig_proto_rawDescGZIP() []byte {
	file_api_conf_v1_remoteconfig_proto_rawDescOnce.Do(func() {
		file_api_conf_v1_remoteconfig_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_conf_v1_remoteconfig_proto_rawDesc), len(file_api_conf_v1_remoteconfig_proto_rawDesc)))
	})
...
func file_api_conf_v1_remoteconfig_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_conf_v1_remoteconfig_proto_rawDesc), len(file_api_conf_v1_remoteconfig_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
