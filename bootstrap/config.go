...
func LoadBootstrapConfig(configPath string) *v1.Bootstrap {
...
func LoadRemoteConfigSourceConfigs(configPath string) (*v1.RemoteConfig, error) {
...
func NewRemoteConfigSource(c *v1.RemoteConfig) config.Source {
...
func NewNacosConfigSource(c *v1.RemoteConfig) config.Source {
...
func NewEtcdConfigSource(c *v1.RemoteConfig) config.Source {
...
func NewConsulConfigSource(c *v1.RemoteConfig) config.Source {
